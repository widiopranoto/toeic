...
storeAllScores();
  ...
  var unKDDefault=localStorage.getItem('unKDDefault');
  var unScoreTotalKDId='unScoreTotalKD'+unKDDefault;
  ...
  //tampilkan modal
  //var unModalScoreKDDefault='unModalScoreKD'+unKDDefault;
  //modalkan(unModalScoreKDDefault);
if(isAnswersComplete()==false)
 {
	alert("You have not answered all questions. Try again after you have done it. Go back and then click 'Show My Answers' to find out where you missed the answer(s)"); 
	return false;
 }
else if(isAnswersComplete()==true)
 {
